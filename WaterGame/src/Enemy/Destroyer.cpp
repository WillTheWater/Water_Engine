...
namespace we
{
	Destroyer::Destroyer(World* OwningWorld, const string TexturePath, const sf::Vector2f& Velocity)
		...
		, Shooter1{ new BulletShooter{this, 1.f, {20.f, 40.f}} }
		, Shooter2{ new BulletShooter{this, 1.f, {-20.f, 40.f}} }
		, Shooter3{ new BulletShooter{this, 1.f, {100, 50.f}} }
		, Shooter4{ new BulletShooter{this, 1.f, {-100, 50.f}} }
