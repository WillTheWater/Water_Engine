...
**Water Engine** is a work in progress custom game engine built with **SFML 3** and **Box2D**. Provides a simple, modular framework for managing scenes, actors, physics, and rendering.
