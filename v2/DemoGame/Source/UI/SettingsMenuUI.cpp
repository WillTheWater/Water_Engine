...
//		auto HBox1 = Subsystem.GUI->CreateWidget<HorizontalBox>(Subsystem, vector<shared<Widget>>{VsyncText, VsyncToggle});
//
...
//		auto HBox2 = Subsystem.GUI->CreateWidget<HorizontalBox>(Subsystem, vector<shared<Widget>>{MuteText, MuteToggle});
//
...
//		auto HBox3 = Subsystem.GUI->CreateWidget<HorizontalBox>(Subsystem, vector<shared<Widget>>{MVText, MasterV});
//
...
//		auto HBox4 = Subsystem.GUI->CreateWidget<HorizontalBox>(Subsystem, vector<shared<Widget>>{MuVText, MusicV});
//		
...
//		auto HBox5 = Subsystem.GUI->CreateWidget<HorizontalBox>(Subsystem, vector<shared<Widget>>{AVText, AmbientV});
//		
...
//		auto HBox6 = Subsystem.GUI->CreateWidget<HorizontalBox>(Subsystem, vector<shared<Widget>>{SFXVText, SFXV});
//
...
//		auto HBox7 = Subsystem.GUI->CreateWidget<HorizontalBox>(Subsystem, vector<shared<Widget>>{FSText, ToggleFullscreenButton});
//
...
//			vector<shared<Widget>>{ExitButton}, 0.f, Anchor::Center, Anchor::Center, vec2f{265,100});
//
//		auto VBox = Subsystem.GUI->CreateWidget<VerticalBox>(Subsystem, vector<shared<Widget>>
//		{
//			HBox1, 
//			HBox2, 
//			HBox3,
